...
# Usar la variable de entorno DEBUG si está definida, de lo contrario usar False para producción
...
# Verificar si estamos en Railway (Railway siempre proporciona variable DATABASE_URL)
if 'DATABASE_URL' in os.environ:
    # Parse DATABASE_URL proporcionado por Railway
