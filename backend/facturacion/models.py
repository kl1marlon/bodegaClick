...
class Producto(models.Model):
    ...
    aplicar_iva = models.BooleanField(null=True, default=False)  # Permitir NULL para coincidir con la DB
    fuente_actualizacion = models.CharField(max_length=50, default='loyverse', help_text="Indica la fuente de la última actualización (loyverse, factura)")  # Quitado blank=True porque la DB no permite NULL
    porcentaje_ganancia = models.DecimalField(max_digits=5, decimal_places=2, default=30.00)  # Añadido
    tipo_tasa = models.CharField(max_length=10, default='BCV')  # Añadido
    es_precio_variable = models.BooleanField(default=False)  # Añadido
    def __str__(self):
        return self.nombre
